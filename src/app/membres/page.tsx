      ...
      <section className="relative h-[550px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-white/90 animate-fade-in">
            Rejoignez la plus grande communauté d'entrepreneurs et de PME de
            Côte d'Ivoire
          </p>
        </div>
      </section>
          ...
          <Tabs defaultValue="annuaire" className="w-full">
            <div className="flex justify-center mb-12 overflow-x-auto">
              <div className="w-auto">
                <TabsList className="w-auto h-auto bg-transparent border-0 flex justify-center gap-2 sm:gap-2.5">
                  <TabsTrigger
                    value="annuaire"
                    className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm whitespace-nowrap px-4 py-2 rounded-md border border-gray-200 bg-white hover:bg-gray-50 hover:border-cpu-orange transition-all"
                  >
            ...
            <TabsContent value="annuaire" className="mt-8">
              ...
              <div className="mb-20 animate-fade-in-up">
                ...
                {featuredMembers.length > 0 ? (
                    ...
                    <div className="border border-gray-200 rounded-lg p-6 md:p-8 transition-all overflow-hidden bg-white">
                      ...
                      >
                        <div className="flex-shrink-0 bg-[#f0f4f8] rounded-lg w-full md:w-64 h-40 md:h-48 flex items-center justify-center overflow-hidden relative">
                          {shouldShowImage(featuredMembers[featuredIndex].id) &&
                          featuredMembers[featuredIndex].logoUrl ? (
                            <Image
                              ...
                              onError={() =>
                                handleImageError(
                                  featuredMembers[featuredIndex].id
                                )
                              }
                            />
                          ) : (
                            <div
                              className={`absolute inset-0 bg-gradient-to-br ${getSectorColor(
                                featuredMembers[featuredIndex].sector
                              )} flex items-center justify-center`}
                            >
                              <div className="text-center text-white px-4">
                                <p className="text-sm font-semibold line-clamp-2">
                                  {featuredMembers[featuredIndex].name}
                                </p>
                              </div>
                            </div>
                          )}
                        ...
                        <div className="flex-1 flex flex-col justify-between">
                          <div>
                            ...
                            <p className="text-[#6F6F6F] text-base leading-relaxed mb-6">
                              {featuredMembers[featuredIndex].description}
                            </p>
                          </div>
                  ...
                  <p className="text-gray-500">
                    Aucun membre à la une pour le moment.
                  </p>
                )}
              </div>
              ...
              <div className="animate-fade-in-up animate-delay-300">
                <h2 className="text-3xl font-bold mb-10 text-[#221F1F]">
                  Tous les Membres
                </h2>
                    ...
                    >
                      ...
                      <div className="p-6 flex flex-col flex-1">
                        <div className="mb-4 flex gap-2">
                          {member.featured && (
                            <Badge className="bg-cpu-green text-white">
                              Actif
                            </Badge>
                          )}
